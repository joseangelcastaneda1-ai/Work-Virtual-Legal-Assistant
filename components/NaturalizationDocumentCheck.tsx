...
interface NaturalizationDocumentCheckProps {
  checkResult: { hasMinimumDocuments: boolean; missingDocuments: string[] } | null;
}

const NaturalizationDocumentCheck: React.FC<NaturalizationDocumentCheckProps> = ({ checkResult }) => {
  if (!checkResult) {
    return null;
  }
...
export default NaturalizationDocumentCheck;
